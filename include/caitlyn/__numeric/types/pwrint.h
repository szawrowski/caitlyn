...
public:
    ...
    pwrint_t(pwrint_t&& other) noexcept : digits_(std::move(other.digits_)), is_negative_(other.is_negative_)
    {
...
inline bool operator<(const cait::numeric::pwrint_t& lhs, const cait::numeric::pwrint_t& rhs)
{
...
inline cait::numeric::pwrint_t operator+(const cait::numeric::pwrint_t& lhs, const cait::numeric::pwrint_t& rhs)
{
    return lhs.add(rhs);
}
...
inline std::ostream& operator<<(std::ostream& os, const cait::numeric::pwrint_t& number)
{
    os << number.to_string();
    return os;
}

inline cait::numeric::pwrint_t operator""_pwrint(const char* number, const size_t)
{
