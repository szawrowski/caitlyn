...
#define __CAITLYN_GLOBAL_NAMESPACE_BEGIN                                                                               \
    namespace cait                                                                                                     \
    {
#define __CAITLYN_GLOBAL_NAMESPACE_END }

#define __CAITLYN_DETAIL_NAMESPACE_BEGIN                                                                               \
    namespace __detail                                                                                                 \
    {
#define __CAITLYN_DETAIL_NAMESPACE_END }

#define __CAITLYN_DEF_NAMESPACE_BEGIN                                                                                  \
    namespace def                                                                                                      \
    {
#define __CAITLYN_DEF_NAMESPACE_END }

#define __CAITLYN_FORMAT_NAMESPACE_BEGIN                                                                               \
    namespace fmt                                                                                                      \
    {
#define __CAITLYN_FORMAT_NAMESPACE_END }

#define __CAITLYN_ERROR_NAMESPACE_BEGIN                                                                                \
    namespace error                                                                                                    \
    {
#define __CAITLYN_ERROR_NAMESPACE_END }

#define __CAITLYN_TRAITS_NAMESPACE_BEGIN                                                                               \
    namespace traits                                                                                                   \
    {
#define __CAITLYN_TRAITS_NAMESPACE_END }

#define __CAITLYN_NUMERIC_NAMESPACE_BEGIN                                                                              \
    namespace numeric                                                                                                  \
    {
#define __CAITLYN_NUMERIC_NAMESPACE_END }

#define __CAITLYN_JSON_NAMESPACE_BEGIN                                                                                 \
    namespace json                                                                                                     \
    {
#define __CAITLYN_JSON_NAMESPACE_END }

#define __CAITLYN_TESTING_NAMESPACE_BEGIN                                                                              \
    namespace test                                                                                                     \
    {
