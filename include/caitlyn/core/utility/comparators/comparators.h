...
static __caitlyn_constexpr auto cmp_eq(T t, U u) noexcept {
...
template<typename T, typename U>
static __caitlyn_constexpr auto cmp_ne(T t, U u) noexcept {
  return !compare_equal(t, u);
}

template<typename T, typename U>
static __caitlyn_constexpr auto cmp_less(T t, U u) noexcept {
  using UT = typename std::make_unsigned<T>::type;
  using UU = typename std::make_unsigned<U>::type;
...
template<typename T, typename U>
static __caitlyn_constexpr auto cmp_greater(T t, U u) noexcept {
  return compare_less(u, t);
}

template<typename T, typename U>
static __caitlyn_constexpr auto cmp_le(T t, U u) noexcept {
  return !compare_greater(t, u);
}

template<typename T, typename U>
static __caitlyn_constexpr auto cmp_ge(T t, U u) noexcept {
