...
{
    std::ios::sync_with_stdio(false);
    std::cout << format(str, std::forward<Args>(args)...) << def::line_feed << std::flush;
}
...
{
    std::ios::sync_with_stdio(false);
    std::cerr << format(str, std::forward<Args>(args)...) << def::line_feed << std::flush;
}
...
{
    std::ios::sync_with_stdio(false);
    std::clog << format(str, std::forward<Args>(args)...) << def::line_feed << std::flush;
}
