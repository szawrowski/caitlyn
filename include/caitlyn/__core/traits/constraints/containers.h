...
template <typename T>
struct has_begin_t<T, indicator_t<decltype(std::declval<T>().begin())>> : true_t
{
};
...
template <typename T>
struct has_push_back_t<T, indicator_t<decltype(std::declval<T>().push_back(std::declval<typename T::value_type>()))>>
    : true_t
{
};
...
template <typename T>
struct has_pop_back_t<T, indicator_t<decltype(std::declval<T>().pop_back())>> : true_t
{
};
...
template <typename T>
struct has_front_t<T, indicator_t<decltype(std::declval<T>().front())>> : true_t
{
};
...
template <typename T>
struct has_clear_t<T, indicator_t<decltype(std::declval<T>().clear())>> : true_t
{
};
...
template <typename T>
struct has_resize_t<T, indicator_t<decltype(std::declval<T>().resize(std::declval<typename T::size_type>()))>> : true_t
{
};
...
template <typename T>
struct has_empty_t<T, indicator_t<decltype(std::declval<T>().empty())>> : true_t
{
};
